...
const AVAILABLE_ICONS = {
    ...
    AETHER: { path: "icons/Aether.png", scale: 200},
    VALOR: { path: "icons/Valor.png", scale: 350},
    HUMILITY: { path: "icons/Humility.png", scale: 350},
    HONESTY: { path: "icons/Honesty.png", scale: 350},
    SPIRITUALITY: { path: "icons/Spirituality.png", scale: 350},
